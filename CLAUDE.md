...
- When user has been satisfied that there are no more work to be done, open a pull request. Each pull request *MUST* follow the repository's template and at least provide description of changes and how to test the changes manually.
